...
const testimonials = [
    {
        ...
        rating: 4.5,
        comment: "Wow... I am very happy to use this VPN, it turned out to be more than my expectations and so far there have been no problems. FlashNet VPN always the best",
